...
DYNAMIC_PASSWORD_ENDPOINT = "/v1.0/devices/{device_id}/door-lock/dynamic-password"
TEMP_PASSWORDS_LIST_ENDPOINT = "/v1.0/devices/{device_id}/door-lock/temp-passwords"
